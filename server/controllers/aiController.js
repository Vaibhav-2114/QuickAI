...
export const generateImage = async (req, res) => {
    try {
        ...
        // Cloudinary expects a proper data URI: no whitespace after the comma.
        ...
        const message =
            error?.message ??
            error?.response?.data ??
            (typeof error === 'string' ? error : 'Unknown image generation error')
            ...
            transformation: [
                {
                    ...
                    background_removal: 'remove _the_background'
                }
            ]
        })
